...
latex_documents = [
('OK3576-C_hardware',	             # (修改) 文件名，无后缀
'OK3576-C_hardware.tex',              # (修改) 与文件名保持一致，后缀.tex不变
'FET3576-C OK3576-C',             # (修改) PDF说明书封面标题
'User\'s Hardware Manual',   # (修改) 文档类别 "User's Software Manual / Application Note等"
'manual',                    # (不修改) 文档类别，不修改
False),

('OK3576-C_Linux_use',
'OK3576-C_Linux_use.tex',
'FET3576-C OK3576-C',
'User\'s Software Manual',
'manual',
False)
]
